...
class EnderecosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endereco" do
    assert_difference("Endereco.count") do
      post enderecos_url, params: { endereco: { cep: @endereco.cep, city: @endereco.city, complement: @endereco.complement, neighborhood: @endereco.neighborhood, paciente_id: @endereco.paciente_id, street_avenue: @endereco.street_avenue } }
    end
  ...
  test "should update endereco" do
    patch endereco_url(@endereco), params: { endereco: { cep: @endereco.cep, city: @endereco.city, complement: @endereco.complement, neighborhood: @endereco.neighborhood, paciente_id: @endereco.paciente_id, street_avenue: @endereco.street_avenue } }
