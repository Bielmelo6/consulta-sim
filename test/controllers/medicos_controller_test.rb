...
class MedicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medico" do
    assert_difference("Medico.count") do
      post medicos_url, params: { medico: { birthday: @medico.birthday, cpf: @medico.cpf, crm: @medico.crm, email: @medico.email, name: @medico.name, speciality: @medico.speciality } }
    end
  ...
  test "should update medico" do
    patch medico_url(@medico), params: { medico: { birthday: @medico.birthday, cpf: @medico.cpf, crm: @medico.crm, email: @medico.email, name: @medico.name, speciality: @medico.speciality } }
