...
class ConsultaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consultum" do
    assert_difference("Consultum.count") do
      post consulta_url, params: { consultum: { date: @consultum.date, medico_id: @consultum.medico_id, paciente_id: @consultum.paciente_id, time: @consultum.time } }
    end
  ...
  test "should update consultum" do
    patch consultum_url(@consultum), params: { consultum: { date: @consultum.date, medico_id: @consultum.medico_id, paciente_id: @consultum.paciente_id, time: @consultum.time } }
