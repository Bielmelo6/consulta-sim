...
class PacienteTest < ActiveSupport::TestCase
  ...
  test 'Criando paciente com a data de nascimento invalida' do
    paciente = Paciente.new name: 'Gabriel Melo', birthday: Date.parse("Dec 6 2025"),
                            cpf: '129342224-03', email: 'gabrielmelodemenezes@gmail.com'
    assert_not paciente.save
  end

  test 'Criando paciente sem os campos preenchidos' do
